...
import 'package:the_library/data/vos/buy_links_vo.dart';
...
List<BookListVO> getMockBookDetailsList() {
  return [
    BookListVO(
        704,
...
List<BookVO> getMockBooksByListName() {
  return [
    BookVO(
      ...
      "2021-10-15 20:13:01",
      1,
      [BuyVO("Amazon", "https://www.amazon.com/dp/0735222355?tag=NYTBSREV-20")],
      1,
      0,
      [
        IsBnVO(
...
List<BookVO> getMockReadBooks() {
  return [
    ...
    BookVO(
      ...
      "2021-10-15 20:13:01",
      1,
      [BuyVO("Amazon", "https://www.amazon.com/dp/0063142937?tag=NYTBSREV-20")],
      1,
      0,
      [
        IsBnVO(
...
BookListResultsVO getMockBookList() {
  return BookListResultsVO(
      "2021-08-28", "2021-09-12", null, "2021-09-05", "2021-09-19", [
    BookListVO(
        704,
        "Combined Print and E-Book Fiction",
        "combined-print-and-e-book-fiction",
